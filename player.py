...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, taille):
        ...
        self.idle = [pygame.image.load(f"./mc/Idle ({i}).png") for i in range(1, 6)]
        self.dead = [pygame.image.load(f"./mc/Dead ({i}).png") for i in range(1, 6)]
        self.run = [pygame.image.load(f"./mc/Run ({i}).png") for i in range(1, 6)]
